...
const BRAND_DISPLAY = "Vila Coral";
const BRAND_NAME = "VILA CORAL";
...
const NIGHTS = ["1泊", "2泊", "3泊", "4泊以上"];
const GUESTS = ["1名", "2名", "3名", "4名"];
...
export default function ReservationSp() {
  ...
  const inputClass =
    "w-full min-h-[42px] appearance-none rounded-none border-0 border-b border-[rgba(32,63,65,0.14)] bg-transparent pb-2 font-sans text-[16px] leading-[1.8] tracking-[0.02em] text-[rgba(29,41,40,0.90)] outline-none transition duration-500 placeholder:text-[rgba(32,63,65,0.28)] focus:border-[rgba(32,63,65,0.42)] sm:text-[13px]";
  ...
  return (
    <section
      id="reservation"
      ref={sectionRef}
      aria-label={`${BRAND_DISPLAY} reservation`}
      className="relative overflow-hidden bg-base py-24 scroll-mt-[88px] sm:py-28 lg:py-32"
    >
      {/* soft image memory */}
      <div
        className="pointer-events-none absolute right-0 top-0 z-0 h-[56%] w-[68%] overflow-hidden opacity-80 sm:h-[62%] sm:w-[52%] lg:inset-y-0 lg:h-auto lg:w-[38%]"
        aria-hidden="true"
      >
        <img
          src="/images/reservation-vertical.jpeg"
          alt=""
          className="h-full w-full object-cover object-[52%_50%] opacity-[0.24] brightness-[1.04] saturate-[0.78] lg:opacity-[0.28]"
        />

        <div className="absolute inset-0 bg-[linear-gradient(270deg,rgba(247,245,239,0.00)_0%,rgba(247,245,239,0.42)_42%,rgba(247,245,239,0.96)_88%,rgba(247,245,239,1)_100%)]" />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(247,245,239,0.92)_0%,rgba(247,245,239,0.10)_36%,rgba(247,245,239,1)_100%)] lg:bg-[linear-gradient(180deg,rgba(18,32,34,0.08)_0%,rgba(18,32,34,0.00)_32%,rgba(18,32,34,0.10)_100%)]" />
      </div>

      {/* ambient typography */}
      <div
        className="pointer-events-none absolute bottom-[8%] left-[-4vw] z-0 hidden lg:block"
        aria-hidden="true"
      >
      ...
      <div
        className="pointer-events-none absolute left-0 top-[20%] h-px w-full bg-[linear-gradient(90deg,transparent,rgba(32,63,65,0.10),transparent)]"
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1440px] px-6 sm:px-10 lg:px-16">
        ...
        <div className="relative pt-16 sm:pt-20 lg:pt-24">
          <div className="grid grid-cols-1 gap-14 lg:grid-cols-[minmax(0,430px)_minmax(0,1fr)] lg:items-start lg:gap-20">
            {/* left */}
            <div className="relative z-10 lg:pt-6">
              ...
              >
                {BRAND_DISPLAY}は、1日1組のみのご案内です。
                <br />
                ご希望日・泊数・人数をお送りいただければ、空室状況と目安料金を確認してご返信します。
                <br />
                <br />
                送信だけで予約は確定しません。
                <br />
              ...
              >
                {INFO_ROWS.map((item, index) => (
                  <div
                    key={item.label}
                    className={`flex items-center justify-between gap-8 py-3 font-sans text-[11px] tracking-[0.16em] text-[rgba(32,63,65,0.44)] ${
                  ...
                  >
                    ...
                    <span className="text-right text-[rgba(32,63,65,0.60)]">
                      {item.value}
                    </span>
                  </div>
                ))}
            ...
            <div className="relative">
              <div
                className="pointer-events-none absolute -inset-x-4 top-8 h-[82%] border border-[rgba(32,63,65,0.055)] bg-[rgba(255,253,248,0.26)] shadow-[0_34px_90px_rgba(20,36,38,0.07)] sm:-inset-x-6"
                aria-hidden="true"
              />

              <div
                className={`${reveal.reveal} ${reveal.d2} ${inClass} relative border border-[rgba(32,63,65,0.11)] bg-[rgba(255,253,248,0.90)] shadow-[0_28px_80px_rgba(20,36,38,0.11)] backdrop-blur-[0.2px]`}
              >
                <div
                  className="pointer-events-none absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.40)_0%,rgba(255,255,255,0.00)_42%,rgba(32,63,65,0.025)_100%)]"
                  aria-hidden="true"
                />
                  ...
                  <form className="mt-9 grid gap-8" onSubmit={handleSubmit}>
                    ...
                    <div className="mt-2 border-t border-[rgba(32,63,65,0.10)] pt-8">
                      <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <button
                          type="submit"
                          className="group inline-flex w-fit items-center gap-4 border border-[rgba(32,63,65,0.15)] bg-[rgba(255,253,248,0.92)] px-7 py-[12px] font-sans text-[11px] tracking-[0.18em] text-[rgba(29,41,40,0.88)] shadow-[0_16px_44px_rgba(20,36,38,0.10)] transition duration-500 hover:border-[rgba(32,63,65,0.25)] hover:bg-[rgba(255,253,248,0.98)] hover:shadow-[0_22px_60px_rgba(20,36,38,0.14)] active:translate-y-[1px]"
                        >
                          <span>空室確認を送る</span>
                          <span
